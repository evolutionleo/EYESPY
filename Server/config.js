...
const common_config = {
    ...
    dt_enabled: false, // toggles delta time for entity physics
...
const prod_config = {
    ...
    port: parseInt(args.port) || 3735,
    ws_port: parseInt(args.ws_port) || 37355,
    ...
    ssl_enabled: true,
    ssl_cert_path: '/etc/letsencrypt/live/evoleo.ru/cert.pem',
    ssl_key_path: '/etc/letsencrypt/live/evoleo.ru/privkey.pem',
